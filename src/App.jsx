...
const [selectedTeam ,setTeam] = useState(JSON.parse(localStorage.getItem('selectedTeam')) ||"TeamC");
  ...
  function handleClick(event){
    ...
    setEmplyees(transformedemployees);
 ...
 const [employees,setEmplyees] = useState( JSON.parse(localStorage.getItem('employeeList'))||[{
    id: 1,
    fullName: "Bob Jones",
  ...
  return (
    <main>
      ...
      <Routes>
        <Route path = "/" element = {<Employees  employees = {employees} selectedTeam = {selectedTeam} handleOnchange = {handleOnchange} handleClick = {handleClick} />}>
 </Route>
